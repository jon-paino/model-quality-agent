#!/usr/bin/env bash
# Build the ModelOp Open Processor and install it into Striim's UploadedFiles.
#
# All Striim dependencies are system-scoped; ONNX Runtime is bundled by shade.
# Maven shade produces target/ModelOp.jar; we copy it to
# $STRIIM_HOME/UploadedFiles/ModelOp.scm, then load it in the Striim console:
#
