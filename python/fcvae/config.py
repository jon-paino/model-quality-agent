...
# Feast side (F2): second local feature repo + HTTP feature server carrying
# the per-combo scoring params. Registry and sqlite online store live under
# feature_repo/data/ (gitignored; regenerated by `fcvae.feast_setup apply`).
FEATURE_REPO = Path(os.environ.get("FCVAE_FEATURE_REPO") or (FCVAE_ROOT / "feature_repo"))
FEAST_URL = os.environ.get("FCVAE_FEAST_URL") or "http://127.0.0.1:6567"
